...
def get_Mahalanobis_score(model, test_loader, num_classes, outf, out_flag, sample_mean, precision, layer_index,
                          magnitude):
    '''
    ...
    for data, target in test_loader:
        ...
        noise_out_features = model.intermediate_forward(Variable(tempInputs, volatile=True), softmax=False,
